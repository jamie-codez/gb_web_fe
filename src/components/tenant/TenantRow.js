    ...
    return (
        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td className="px-6 py-4">
                <div className="pl-3">
                    <div className="text-base font-semibold">Full Name: {house? house.firstName:" "+house?house.lastName:""}</div>
                    <div className="font-normal text-gray-500">First Name: {house?house.firstName:""}</div>
                    <div className="font-normal text-gray-500">Last Name: {house?house.lastName:""}</div>
                    <div className="font-normal text-gray-500">Email: {house?house.email:""}</div>
                </div>
            </td>
            <td className="px-6 py-4">
                <div className="pl-3">
